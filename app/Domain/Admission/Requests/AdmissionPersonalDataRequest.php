...
class AdmissionPersonalDataRequest extends FormRequest
{
    ...
    public function rules(?string $same_address): array
    {
        return [
            ...
            'temporary_municipality' => $same_address ? ['nullable', 'max:255'] : ['required', 'max:255'],
            ...
            'mobile_number' => ['required', 'string', 'max:11', 'min:11', new PhoneNumber()],
            ...
            'mean_ages_of_siblings' => ['required', 'numeric', 'max:255'],
